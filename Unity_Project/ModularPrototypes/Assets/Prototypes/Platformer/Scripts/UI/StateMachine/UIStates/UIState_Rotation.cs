...
{
    public class UIState_Rotation : UIState
    {
        ...
        {
            stateName = string.IsNullOrEmpty(stateName) ? "Rotation" : stateName;
            transformDomain = PlatformTransformationSettings.TransformDomain.ROTATION;
        ...
        {
            _axisDropdown.value = (int)platformConfig.GetTransformDimension();
